...
<p align="center">
  <a href="https://github.com/kardelitaitu/a-note/releases/tag/v0.4.0">⬇ Download notes.exe (v0.4.0)</a>
</p>
...
**[⬇ Download notes.exe (v0.4.0)](https://github.com/kardelitaitu/a-note/releases/tag/v0.4.0)**
...
```bash
# 242 tests across unit, integration, and property-based suites
cd src-tauri
cargo test --lib              # 200 unit tests
cargo test --test encryption  # 24 integration tests
cargo test --test property    # 18 property-based tests (proptest)
```
